...
urlpatterns = [
    ...
    path('accounts/login/',auth_views.LoginView.as_view(template_name=
        'app/login.html',authentication_form=LoginForm),name='login'),
    path('logout/',auth_views.LogoutView.as_view(next_page='login'),name='logout'),
    path('passwordchange/',auth_views.PasswordChangeView.as_view(template_name='app/passwordchange.html',
        form_class=MyPasswordChangeForm,success_url='/passwordsuccessfullychanged'),name='passwordchange'),
    
    path('passwordsuccessfullychanged',auth_views.PasswordChangeView.as_view
        
         (template_name='app/passwordsuccessfullychanged.html'),name='passwordsuccessfullychanged'),
